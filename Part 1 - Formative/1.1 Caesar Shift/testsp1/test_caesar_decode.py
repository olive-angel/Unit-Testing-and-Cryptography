...
class TestCaesarDecode(TestCase):
    ...
    def test_caesar_decode_with_empty_second_parameter(self):
        self.assertEqual(caesar_decode("mjqqtbtwqi", None), "mjqqtbtwqi")
    def test_caesar_decode_with_empty_first_parameter(self):
